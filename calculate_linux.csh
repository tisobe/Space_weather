...
/usr/bin/lynx -source $file > $SPACE_Wdir/returned
...
/usr/bin/lynx -source http://services.swpc.noaa.gov/images/ace-epam-7-day.gif | /opt/local/bin/convert -negate - - >! $WEBdir/Epam_7di.gif
/usr/bin/lynx -source http://services.swpc.noaa.gov/images/ace-epam-7-day.gif >! $WEBdir/Epam_7d.gif
/usr/bin/lynx -source http://services.swpc.noaa.gov/images/ace-epam-7-day.gif >! $WEBdir/mta_ace_plot.gif
...
/usr/bin/lynx -source http://services.swpc.noaa.gov/images/ace-mag-swepam-7-day.gif >! $WEBdir/Mag_swe_7d.gif
...
##/usr/bin/lynx -source http://www.swpc.noaa.gov/wingkp/wingkp_15m_24h.gif >!  $WEBdir/wingkp.gif
